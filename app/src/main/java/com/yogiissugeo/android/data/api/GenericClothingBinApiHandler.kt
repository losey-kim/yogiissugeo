...
import com.yogiissugeo.android.data.parser.ClothingBinParser
import retrofit2.Response

/**
 * ClothingBinApiHandler는 특정 API 소스에서 의류 수거함 데이터를 가져오고 가공하는 역할을 합니다.
 *
 * @param clothingBinApi 의류 수거함 데이터를 요청하는 Retrofit API 인터페이스
 */
class ClothingBinApiHandler(
